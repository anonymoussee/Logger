...
def infer_llm(instruction, query, exemplars=None, model='text-davinci-003', temperature=0.0, max_tokens=2048):
...
def main():
    input_folder = "./test"
    output_folder = "./results/davinci-003"
